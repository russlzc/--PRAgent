...
class TaskQueue:
    STREAM = "pragent:review:stream"
    DLQ = "pragent:review:dlq"
    GROUP = "pragent-workers"
    ...
    def __init__(
        ...
        self._executor = ThreadPoolExecutor(max_workers=workers, thread_name_prefix="pragent-worker")
        self._redis = None
