...
SOURCE = ROOT / "docs" / "PRReviewAgent知识库.md"
OUTPUT = ROOT / "output" / "pdf" / "PRReviewAgent知识库.pdf"
...
def footer(canvas, document) -> None:
    ...
    canvas.drawString(LEFT, 6.6 * mm, "PR Review Agent 知识库")
...
def build() -> None:
    ...
    document = SimpleDocTemplate(
        ...
        topMargin=TOP,
        bottomMargin=BOTTOM,
        title="PR Review Agent 知识库",
        author="PR Review Agent",
        subject="PR Review Agent 项目知识库",
    )
